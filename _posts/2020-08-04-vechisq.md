...
To run this slim function 1000 time would require using something like `apply()`, looping over every test and thus taking 1000 times longer. To improve the efficiency of our function, we can vectorise the code. Below is the vectorised version, lets go through it line by line. 
